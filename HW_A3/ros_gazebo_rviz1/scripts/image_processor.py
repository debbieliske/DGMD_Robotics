...
from sensor_msgs.msg import CompressedImage, CameraInfo # CompressedImage message type
...
def CameraInfoCallback(message):
    global camera_info
    # all the camera data (header, height, width, distortion_model, D, K, R, P, binning_x, binning_y, roi)
    camera_info = message
    # pull useful bits
